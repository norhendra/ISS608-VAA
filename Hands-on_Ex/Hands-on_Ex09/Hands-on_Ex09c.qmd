...
I have adjusted the code chunks a little to add cosmetic tweaks so that the labels are not mashed together. I hope the effort is recognized and appreciated
:::
...
Readjusted so the labels are not jumbled up and mashed together with either library(scales) or below code chunk -

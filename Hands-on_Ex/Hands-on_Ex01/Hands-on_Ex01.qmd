...
## 4.5 Plotting a boxplots: geom_boxplot()

The code chunk below plots a boxplot which displays a continuous value list by visualising 5 summary statistics (the median, two hinges and two whispers), and all "outlying" points individually.
...
For the boxplots below, they are considered incomplete because the positions of the means were not shown

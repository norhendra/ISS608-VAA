...
pacman::p_load(scales, viridis, lubridate, ggthemes,
               ...
               gganimate,ggplot2,dplyr,scales)
```
...
animate(p, nframes = 40, fps = 10, width = 600, height = 450)
```
...
This now makes more sense! We can see how each country rice yield decrease or increase over the years.
:::

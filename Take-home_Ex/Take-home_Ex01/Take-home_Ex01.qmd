...
## 1.1 Importing Packages {#importingpackages}
...
# 2. Data Cleaning and Quality Checks {#datacleaningqc}
...
Our journey begins with the shape of this change: a population structure that has slimmed at the base and swelled at the top. From there, we follow the footsteps of the “sandwich generation,” where working‑age adults bear the combined responsibilities of childcare and eldercare, and see how that burden plays out from the Central Core to the island’s quieter corners. Finally, we walk the streets of each planning area to discover the median age that defines its character, whether it’s a youthful promise in Punggol or a seasoned community in Queenstown. Along the way, these insights reveal not just numbers on a page but the evolving stories of homes, families and the future Singapore we are building together.
...
The 2024 population pyramid lays bare a society in transition: its base has thinned while its summit has swelled, reflecting both falling birth rates and rising longevity. Children and adolescents (ages 0–18) now comprise just under 19% of residents while the prime working‑age group (20–54) still represents the largest share at roughly 48%, though its growth has begun to taper. Meanwhile, those aged 55 and over make up about 33% of the population which underscores the urgent need to expand healthcare capacity and elder‑support services.
